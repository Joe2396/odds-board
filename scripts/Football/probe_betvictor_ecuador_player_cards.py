...
It checks Ecuador v Curacao and:
...
OUT_PATH = ROOT / "football" / "data" / "betvictor_player_cards_ECUADOR_PROBE.json"
DEBUG_DIR = ROOT / "football" / "debug" / "betvictor_player_cards_ecuador_probe"
