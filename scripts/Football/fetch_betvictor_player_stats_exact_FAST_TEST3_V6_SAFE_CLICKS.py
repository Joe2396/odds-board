#!/usr/bin/env python3
# BETVICTOR_PLAYER_STATS_EXACT_FAST_TEST3_V6_SAFE_CLICKS
"""
...
Output:
    football/data/betvictor_player_stats_exact_fast_test_v6_safe_clicks.json
...
OUT_PATH = DATA_DIR / "betvictor_player_stats_exact_fast_test_v6_safe_clicks.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_player_stats_exact_fast_test_v6_safe_clicks"
...
def main():
    ...
    print("BETVICTOR EXACT PLAYER STATS — FAST TEST3 V6 SAFE CLICKS")
    print("=" * 72)
