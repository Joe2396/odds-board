#!/usr/bin/env python3
"""
fetch_williamhill_worldcup_props_FAST_TEST3_V17_SCOPED_SHOW_MORE.py

William Hill World Cup props scraper — FAST TEST3 V17 candidate — V16 plus market-scoped Show More expansion.
...
Output:
  football/data/williamhill_worldcup_props_FAST_TEST3_V17_SCOPED_SHOW_MORE.json
...
OUT_PATH  = ROOT / "football" / "data" / "williamhill_worldcup_props_FAST_TEST3_V17_SCOPED_SHOW_MORE.json"
DEBUG_DIR = ROOT / "football" / "debug" / "williamhill_worldcup_props_FAST_TEST3_V17_SCOPED_SHOW_MORE"
...
def scrape_match(page, fixture):
    ...
    return {
        ...
        "capture_strategy": "v17_v15_impact_sub_plus_scoped_players_show_more",
        "diagnostics": str(diag_path),
        "market_count": len(markets),
        "player_market_count": player_market_count,
        "player_selection_count": player_selection_count,
...
def main():
    ...
    print("=" * 60)
    print("William Hill World Cup Props Scraper — FAST TEST3 V17 SCOPED SHOW MORE")
