#!/usr/bin/env python3
# BETVICTOR_PLAYER_STATS_EXACT_PROD15_FAST_V1
"""
...
This scraper writes football/data/betvictor_player_stats_exact.json.
...
def main():
    ...
    print("BETVICTOR EXACT PLAYER STATS — PROD15 FAST")
    print("=" * 72)
