#!/usr/bin/env python3
# BETVICTOR_BETBUILDER_MATCH_STATS_FAST_TEST3_V1
"""
...
Output:
    football/data/
    betvictor_worldcup_betbuilder_stats_fast_test_v1.json
...
DEBUG_ROOT = (
    ...
    / "football"
    / "debug"
    / "betvictor_betbuilder_stats_fast_test_v1"
)
...
INITIAL_SETTLE_MS = 1200
TAB_CLICK_WAIT_MS = 700
...
def click_match_stats_tab(
    ...
    text_item, _ = visible_exact_text(
        page,
        ["Match Stats"],
    )
...
def main() -> None:
    ...
    output = {
        ...
        "bookmaker": "BetVictor",
        "market_type":
            "bet_builder_match_stats_fast_test_v1",
        "test_mode": True,
        "generated_at":
            datetime.now(
                timezone.utc
