...
OUT_PATH = (
    ...
    / "football"
    / "data"
    / "betvictor_betbuilder_stats_v3_view.html"
)
...
<title>BetVictor Bet Builder Stats V3</title>
<style>
:root {{
  color-scheme: dark;
...
<body>
<header>
  <h1>BetVictor Bet Builder Stats — V3 Row Pairing</h1>
  <div class="meta">
...
'''
    ...
    print("Built BetVictor Bet Builder V3 data page:")
    print(OUT_PATH)
