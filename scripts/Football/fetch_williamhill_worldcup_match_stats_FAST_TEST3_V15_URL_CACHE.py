#!/usr/bin/env python3
"""
fetch_williamhill_worldcup_match_stats_FAST_TEST3_V15_URL_CACHE.py

FAST TEST3 candidate based on the working V14 parser, using V23 exact event URL cache.
...
OUT_PATH = ROOT / "football" / "data" / "williamhill_worldcup_match_stats_FAST_TEST3_V15_URL_CACHE.json"
DEBUG_DIR = ROOT / "football" / "debug" / "williamhill_worldcup_match_stats_FAST_TEST3_V15_URL_CACHE"
...
def main():
    ...
    print("=" * 60)
    print("William Hill Match/Team Stats — FAST TEST3 V15 URL CACHE")
    print("TEST MODE: MAX_MATCHES = 3 — production untouched")
    print("=" * 60)
