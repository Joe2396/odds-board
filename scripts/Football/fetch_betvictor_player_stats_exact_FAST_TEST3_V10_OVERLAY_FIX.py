#!/usr/bin/env python3
# BETVICTOR_PLAYER_STATS_EXACT_FAST_TEST3_V10_OVERLAY_FIX
"""
...
Output:
    football/data/betvictor_player_stats_exact_fast_test_v10_overlay_fix.json
...
OUT_PATH = DATA_DIR / "betvictor_player_stats_exact_fast_test_v10_overlay_fix.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_player_stats_exact_fast_test_v10_overlay_fix"
...
def main():
    ...
    print("BETVICTOR EXACT PLAYER STATS — FAST TEST3 V10 OVERLAY FIX")
    print("=" * 72)
