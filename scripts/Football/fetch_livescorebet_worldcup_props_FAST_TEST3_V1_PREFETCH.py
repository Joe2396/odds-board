...
OUT_PATH  = ROOT / "football" / "data" / "livescorebet_worldcup_props_FAST_TEST3_V1_PREFETCH.json"
DEBUG_DIR = ROOT / "football" / "debug" / "livescorebet_worldcup_props_FAST_TEST3_V1_PREFETCH"
...
def main():
    ...
    print("=" * 60)
    print("LiveScoreBet Props — FAST TEST3 V1 PREFETCH")
    print("=" * 60)
    ...
    output = {
        ...
        "market_type": "props",
        "scraper_version": "fast_test3_v1_prefetch",
