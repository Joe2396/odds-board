#!/usr/bin/env python3
"""
fetch_ladbrokes_worldcup_props_FAST_TEST3_V2_PLAYER_CARDS.py
...
OUT_PATH  = ROOT / "football" / "data" / "ladbrokes_worldcup_props_fast_test_v2_player_cards.json"
DEBUG_DIR = ROOT / "football" / "debug" / "ladbrokes_worldcup_props_fast_test_v2_player_cards"
...
def main():
    ...
    print("=" * 60)
    print("Ladbrokes World Cup Props FAST TEST3 V2 PLAYER CARDS")
    print("=" * 60)
