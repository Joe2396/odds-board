#!/usr/bin/env python3
"""
fetch_williamhill_worldcup_props_FAST_TEST3_V10_ISOLATED_MARKETS.py

William Hill World Cup props scraper — FAST TEST3 V10 candidate — isolated market capture.
...
Output:
  football/data/williamhill_worldcup_props_FAST_TEST3_V10_ISOLATED_MARKETS.json
...
OUT_PATH  = ROOT / "football" / "data" / "williamhill_worldcup_props_FAST_TEST3_V10_ISOLATED_MARKETS.json"
DEBUG_DIR = ROOT / "football" / "debug" / "williamhill_worldcup_props_FAST_TEST3_V10_ISOLATED_MARKETS"
...
def main():
    ...
    print("=" * 60)
    print("William Hill World Cup Props Scraper — FAST TEST3 V10 ISOLATED MARKETS")
