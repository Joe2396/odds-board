#!/usr/bin/env python3
# BETVICTOR_CORE_PROPS_FAST_TEST3_V6_TOTAL_CARDS_FIX
"""
...
OUT_PATH = ROOT / "football" / "data" / "betvictor_worldcup_props_fast_test_v6_total_cards_fix.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_worldcup_props_fast_test_v6_total_cards_fix"
...
def main():
    ...
    output = {
        ...
        "bookmaker": "BetVictor",
        "market_type": "props_fast_test_v6_total_cards_fix",
        "test_mode": True,
        "source_url": LIST_URL,
