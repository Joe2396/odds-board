#!/usr/bin/env python3
# BETVICTOR_PLAYER_TACKLES_FAST_TEST3_V1
"""
...
Output:
    football/data/betvictor_player_tackles_fast_test_v1.json
...
OUT_PATH = DATA_DIR / "betvictor_player_tackles_fast_test_v1.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_player_tackles_fast_test_v1"
...
def main():
    ...
    print("BETVICTOR PLAYER TACKLES — FAST TEST3 V1")
    print("=" * 72)
    ...
    output = {
        ...
        "bookmaker": "BetVictor",
        "market_type": "player_tackles_fast_test_v1",
        "test_mode": True,
