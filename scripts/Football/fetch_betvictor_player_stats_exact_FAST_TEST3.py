#!/usr/bin/env python3
# BETVICTOR_PLAYER_STATS_EXACT_FAST_TEST3_V1
"""
...
Output:
    football/data/betvictor_player_stats_exact_fast_test.json
...
OUT_PATH = DATA_DIR / "betvictor_player_stats_exact_fast_test.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_player_stats_exact_fast_test"
