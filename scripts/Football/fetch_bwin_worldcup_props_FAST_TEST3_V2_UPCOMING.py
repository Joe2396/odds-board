...
# BWIN_PROPS_FAST_TEST3_V2_UPCOMING
...
OUT_PATH = ROOT / "football" / "data" / "bwin_worldcup_props_fast_test_v2_upcoming.json"
DEBUG_DIR = ROOT / "football" / "debug" / "bwin_worldcup_props_fast_test_v2_upcoming"
...
FAST_CARD_SWEEPS = 12
FAST_STABLE_ROUNDS = 2
FAST_SCROLL_WAIT_MS = 180
...
def collect_cards(page) -> list[dict]:
    ...
    for _ in range(FAST_CARD_SWEEPS):
        cards = page.evaluate(
            CARD_EXTRACTOR,
            TARGET_HEADINGS,
        ) or []
        ...
        page.wait_for_timeout(FAST_SCROLL_WAIT_MS)
...
def main() -> int:
    ...
    print("")
    print("Bwin World Cup props FAST TEST3 V2 UPCOMING completed")
