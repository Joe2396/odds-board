#!/usr/bin/env python3
"""
fetch_williamhill_worldcup_match_stats_FAST_TEST3_CORNERS_CARDS_V4.py

FAST TEST3 match-stats V4: alternate total ladders with scoped expansion.
...
OUT_PATH = ROOT / "football" / "data" / "williamhill_worldcup_match_stats_FAST_TEST3_CORNERS_CARDS_V4.json"
DEBUG_DIR = ROOT / "football" / "debug" / "williamhill_worldcup_match_stats_FAST_TEST3_CORNERS_CARDS_V4"
...
def main():
    ...
    print("=" * 60)
    print("William Hill Match/Team Stats — FAST TEST3 CORNERS + CARDS V4")
