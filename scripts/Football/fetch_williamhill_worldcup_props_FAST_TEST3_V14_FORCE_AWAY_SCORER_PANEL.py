#!/usr/bin/env python3
"""
fetch_williamhill_worldcup_props_FAST_TEST3_V14_FORCE_AWAY_SCORER_PANEL.py

William Hill World Cup props scraper — FAST TEST3 V14 candidate — force and verify away scorer panel.
...
Output:
  football/data/williamhill_worldcup_props_FAST_TEST3_V14_FORCE_AWAY_SCORER_PANEL.json
...
OUT_PATH  = ROOT / "football" / "data" / "williamhill_worldcup_props_FAST_TEST3_V14_FORCE_AWAY_SCORER_PANEL.json"
DEBUG_DIR = ROOT / "football" / "debug" / "williamhill_worldcup_props_FAST_TEST3_V14_FORCE_AWAY_SCORER_PANEL"
...
def scrape_match(page, fixture):
    ...
    return {
        ...
        "capture_strategy": "v14_top_impact_sub_force_verified_both_scorer_teams",
        "diagnostics": str(diag_path),
        "market_count": len(markets),
        "player_market_count": player_market_count,
        "player_selection_count": player_selection_count,
...
def main():
    ...
    print("=" * 60)
    print("William Hill World Cup Props Scraper — FAST TEST3 V14 FORCE + VERIFY AWAY SCORER PANEL")
