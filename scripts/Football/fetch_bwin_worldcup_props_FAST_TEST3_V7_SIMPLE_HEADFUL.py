...
# BWIN_PROPS_FAST_TEST3_V7_SIMPLE_HEADFUL
...
OUT_PATH = ROOT / "football" / "data" / "bwin_worldcup_props_fast_test_v7_simple_headful.json"
DEBUG_DIR = ROOT / "football" / "debug" / "bwin_worldcup_props_fast_test_v7_simple_headful"
...
def main() -> int:
    ...
    print("Scraper mode:             V4 rollback / headful")
    ...
    print("")
    print("Bwin World Cup props FAST TEST3 V7 SIMPLE HEADFUL completed")
