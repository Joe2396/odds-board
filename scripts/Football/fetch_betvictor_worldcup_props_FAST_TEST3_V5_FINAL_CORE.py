#!/usr/bin/env python3
# BETVICTOR_CORE_PROPS_FAST_TEST3_V5_FINAL_CORE
"""
...
OUT_PATH = ROOT / "football" / "data" / "betvictor_worldcup_props_fast_test_v5_final_core.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_worldcup_props_fast_test_v5_final_core"
...
def main():
    ...
    output = {
        ...
        "bookmaker": "BetVictor",
        "market_type": "props_fast_test_v5_final_core",
        "test_mode": True,
        "source_url": LIST_URL,
