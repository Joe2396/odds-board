#!/usr/bin/env python3
# BETVICTOR_CORE_PROPS_FAST_TEST3_V4_PARSE_FIX
"""
...
OUT_PATH = ROOT / "football" / "data" / "betvictor_worldcup_props_fast_test_v4_parse_fix.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_worldcup_props_fast_test_v4_parse_fix"
...
def main():
    ...
    output = {
        ...
        "bookmaker": "BetVictor",
        "market_type": "props_fast_test_v4_parse_fix",
        "test_mode": True,
        "source_url": LIST_URL,
