#!/usr/bin/env python3
"""
fetch_williamhill_worldcup_props_FAST_TEST3_V15_SCROLL_HELPER_FIX.py

William Hill World Cup props scraper — FAST TEST3 V15 candidate — V14 away-panel logic with missing scroll helper restored.
...
Output:
  football/data/williamhill_worldcup_props_FAST_TEST3_V15_SCROLL_HELPER_FIX.json
...
OUT_PATH  = ROOT / "football" / "data" / "williamhill_worldcup_props_FAST_TEST3_V15_SCROLL_HELPER_FIX.json"
DEBUG_DIR = ROOT / "football" / "debug" / "williamhill_worldcup_props_FAST_TEST3_V15_SCROLL_HELPER_FIX"
...
def main():
    ...
    print("=" * 60)
    print("William Hill World Cup Props Scraper — FAST TEST3 V15 SCROLL HELPER FIX")
