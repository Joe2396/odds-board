...
William Hill World Cup props scraper — FAST TEST3 candidate.
...
Output:
  football/data/williamhill_worldcup_props_FAST_TEST3.json
...
OUT_PATH  = ROOT / "football" / "data" / "williamhill_worldcup_props_FAST_TEST3.json"
DEBUG_DIR = ROOT / "football" / "debug" / "williamhill_worldcup_props_FAST_TEST3"
...
def main():
    ...
    print("=" * 60)
    print("William Hill World Cup Props Scraper — FAST TEST3 candidate")
