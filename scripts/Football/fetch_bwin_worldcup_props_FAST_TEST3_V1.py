...
OUT_PATH = ROOT / "football" / "data" / "bwin_worldcup_props_fast_test_v1.json"
DEBUG_DIR = ROOT / "football" / "debug" / "bwin_worldcup_props_fast_test_v1"
...
def main() -> int:
    ...
    print("")
    print("Bwin World Cup props FAST TEST3 V1 completed")
