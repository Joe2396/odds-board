#!/usr/bin/env python3
"""
fetch_ladbrokes_worldcup_props_FAST_TEST3_V1.py
...
OUT_PATH  = ROOT / "football" / "data" / "ladbrokes_worldcup_props_fast_test_v1.json"
DEBUG_DIR = ROOT / "football" / "debug" / "ladbrokes_worldcup_props_fast_test_v1"
...
def scrape_match(page, fixture):
    ...
    try:
        ...
        wait_for_any_text(
            page,
            ["PLAYERS", "SoT", "Shots", "Carded", "Fouls", "Assists"],
            timeout=8000,
        )
    ...
    stage_timings["player_stats"] = time.perf_counter() - stage_started
    print(
...
def main():
    ...
    print("=" * 60)
    print("Ladbrokes World Cup Props FAST TEST3 V1")
    print("=" * 60)
