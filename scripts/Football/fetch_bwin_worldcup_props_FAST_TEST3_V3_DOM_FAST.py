...
# BWIN_PROPS_FAST_TEST3_V3_DOM_FAST
...
OUT_PATH = ROOT / "football" / "data" / "bwin_worldcup_props_fast_test_v3_dom_fast.json"
DEBUG_DIR = ROOT / "football" / "debug" / "bwin_worldcup_props_fast_test_v3_dom_fast"
...
def main() -> int:
    ...
    print("")
    print("Bwin World Cup props FAST TEST3 V3 DOM FAST completed")
