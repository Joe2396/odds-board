#!/usr/bin/env python3
# BETVICTOR_CORE_PROPS_FAST_TEST3_V3_CORE_COMPLETE
"""
...
OUT_PATH = ROOT / "football" / "data" / "betvictor_worldcup_props_fast_test_v3_core_complete.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_worldcup_props_fast_test_v3_core_complete"
...
def main():
    ...
    output = {
        ...
        "bookmaker": "BetVictor",
        "market_type": "props_fast_test_v3_core_complete",
        "test_mode": True,
        "source_url": LIST_URL,
