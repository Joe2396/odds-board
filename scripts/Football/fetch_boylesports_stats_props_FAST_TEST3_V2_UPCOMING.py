...
OUT_PATH = ROOT / "football" / "data" / "boylesports_stats_props_fast_test_v2_upcoming.json"
DEBUG_DIR = ROOT / "football" / "debug" / "boylesports_stats_fast_test_v2_upcoming"
...
def main():
    ...
    output = {
        ...
        "market_type": "stats_props_fast_test_v2_upcoming",
        "test_mode": True,
