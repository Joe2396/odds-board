#!/usr/bin/env python3
# BETVICTOR_PLAYER_STATS_EXACT_FAST_TEST3_V9_GEOMETRY_SCROLL
"""
...
Output:
    football/data/betvictor_player_stats_exact_fast_test_v9_geometry_scroll.json
...
OUT_PATH = DATA_DIR / "betvictor_player_stats_exact_fast_test_v9_geometry_scroll.json"
DEBUG_ROOT = ROOT / "football" / "debug" / "betvictor_player_stats_exact_fast_test_v9_geometry_scroll"
...
def main():
    ...
    print("BETVICTOR EXACT PLAYER STATS — FAST TEST3 V9 GEOMETRY SCROLL")
    print("=" * 72)
